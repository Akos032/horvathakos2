...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 27. 13:15
...
ALTER TABLE `osszekoto`
  ...
  ADD CONSTRAINT `osszekoto_ibfk_7` FOREIGN KEY (`mertekegyseg_id`) REFERENCES `mertekegyseg` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
